...
User.prototype = {
  ...
  loadAllUserData: function(renderCallback) {
    var self = this;
    var promptPromise = self.getPrompts();
  ...
  getPrompts: function() {
    ...
    var promise = new Promise(function(resolve, reject) {
      ...
      prompReq.onload = function() {
         self.prompts = JSON.parse(promptReq.responseText);
         resolve(self);
       };
      prompReq.onerror = function() {
        reject(Error("It broke"));
      };
      prompReq.open('GET', '/userchallenge/' + self.username + '/findallchallenges');
      prompReq.send(null);

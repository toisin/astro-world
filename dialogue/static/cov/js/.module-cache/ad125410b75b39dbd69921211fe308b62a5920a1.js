...
var Title = React.createClass({displayName: 'Title',
  render: function() {
    var prompts = this.props.user.getPrompts(null).map(function(prompt) {
    ...
    return React.DOM.table(null, React.DOM.tbody(null, 
      ...
      React.DOM.tr(null, React.DOM.td(null, prompts))
    ));
  }
});
...
var Prompt = React.createClass({displayName: 'Prompt',
  render: function() {
    return React.DOM.td(null, this.props.prompt,React.DOM.br(null));
  }
});
    ...
    switch (this.state.mode) {
      case 0: //Show User Name
        return React.DOM.table( {className:"app"}, React.DOM.tbody(null, 
          React.DOM.tr(null, 
            React.DOM.td(null, Title( {user:this.props.user}))
          )
        ));

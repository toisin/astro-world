...
User.prototype = {
  ...
  getWorkflowStateID: function() {
    return this.currentWorkflowStateID;
  },
  ...
  loadHistory: function() {
    ...
    var promise = new Promise(function(resolve, reject) {
      ...
      historyReq.onload = function() {
        ...
        self.history = JSON.parse(historyReq.responseText)["messages"];
        resolve();
        // resolve(self);
      };
  ...
  submitTextResponse: function(workflowID, text, renderCallback) {
    ...
    var responsePromise = new Promise(function(resolve, reject) {
      ...
      xhr.send("user=zsdf;response=sdfsdfsd;workflowID=2");
    });

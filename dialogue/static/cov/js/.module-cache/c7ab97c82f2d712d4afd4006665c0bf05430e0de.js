...
var Title = React.createClass({displayName: 'Title',
  render: function() {
    ...
    return  React.DOM.div( {className:"researcher"}, 
...
var Message = React.createClass({displayName: 'Message',
  render: function() {
    ...
    if (message.Mtype == MSG_ROBOT) {
      return  React.DOM.div( {className:"researcher"}, 
                React.DOM.div( {className:"name"}, DisplayText[MSG_ROBOT]),
                React.DOM.div( {className:"message"}, message.Text)
              );
    } else if (message.Mtype == MSG_HUMAN) {
      return  React.DOM.div( {className:"human"}, 
                React.DOM.div( {className:"name"}, human),
                React.DOM.div( {className:"message"}, message.Text)
              );
    }
    console.error("Unknown sender!", error);
    return  React.DOM.div( {className:"researcher"}, 
              React.DOM.div( {className:"message"}, this.props.message.Text)
            );
  }
});
  ...
  render: function() {
    ...
    if (type == PROMPT_TEXT) {
      return  React.DOM.div(null, 
                React.DOM.div( {className:"researcher"}, 
                  React.DOM.div( {className:"name"}, DisplayText[MSG_ROBOT]),
                  React.DOM.div( {className:"message"}, prompt.Text)
                ),
                React.DOM.div( {className:"human"}, 
                  React.DOM.div( {className:"name"}, human),
  ...
  render: function() {
    var option = this.props.option;
      return  React.DOM.label(null, 
                React.DOM.input( {type:"radio", name:"input", value:option.Label}),
                option.Label
              )
  },
});

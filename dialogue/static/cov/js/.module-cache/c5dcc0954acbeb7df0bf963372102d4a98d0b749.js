...
var Title = React.createClass({displayName: 'Title',
  render: function() {
    return React.DOM.table(null, React.DOM.tbody(null, 
      React.DOM.tr(null, React.DOM.td(null, "Researcher: Hello ", this.props.username,"!")),
      React.DOM.tr(null, React.DOM.td(null, "Researcher: Welcome to the Challenge!")),
      React.DOM.tr(null, React.DOM.td(null, "Researcher: Let's get started. What feature are you investigating?"))
    ));
  }
});

...
var Title = React.createClass({displayName: 'Title',
  render: function() {
    return React.DOM.table(null, React.DOM.tr(null, React.DOM.td(null, "Researcher:")),
...
var Prompt = React.createClass({displayName: 'Prompt',
  render: function() {
    return React.DOM.tr(null, React.DOM.td(null, this.props.prompt));
  }
});
...
var App = React.createClass({displayName: 'App',
  ...
  render: function() {
    ...
    var prompts = user.getPrompts(null).map(
        function(prompt) {

...
var Input = React.createClass({displayName: 'Input',
  ...
  handleSubmit: function(event) {
    ...
    var w = document.getElementById("workflowStateID") ? document.getElementById("workflowStateID").value : "";
    var i = document.getElementByName("input")[0] ? document.getElementByName("input")[0].value : "";
    user.submitTextResponse(w, i, onComplete);
  },

...
var MessageTypes = {};
MessageTypes[MSG_ROBOT] = 'Researcher';
MessageTypes[MSG_HUMAN] = 'Student';
...
var Message = React.createClass({displayName: 'Message',
  render: function() {
    if (this.props.message.type == MSG_ROBOT) {
      return React.DOM.div(null, MessageTypes[MSG_ROBOT], " : ", this.props.message.text);
    } else if (this.props.message.type == MSG_HUMAN) {
      return React.DOM.div(null, this.props.message.human, " : ", this.props.message.text);
    }

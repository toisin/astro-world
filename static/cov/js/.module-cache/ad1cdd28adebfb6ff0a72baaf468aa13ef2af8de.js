...
var Prompt = React.createClass({displayName: 'Prompt',
  render: function() {
    if (this.props.prompt.type == PROMPT_ROBOT) {
      return React.DOM.tr(null, React.DOM.td(null, PromptTypes[PROMPT_ROBOT], " : ", this.props.prompt.text));
    } else {
      return React.DOM.tr(null, React.DOM.td(null, PromptTypes[PROMPT_HUMAN], " : ", this.props.prompt.text));
    }
  }
});

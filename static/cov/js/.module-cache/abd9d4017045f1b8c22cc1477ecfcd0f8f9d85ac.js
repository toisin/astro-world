...
User.prototype = {
  ...
  loadAllUserData: function(renderCallback) {
    var self = this;
    var cartPromise = self.loadUserCartData(self.username);
  ...
  loadUserChallengeData: function(username) {
    var self = this;
    var promise = new Promise(function(resolve, reject) {
      ...
      challengeReq.open('GET', '/userchallenge/' + username + '/findallchallenges');
  ...
  loadUserCartData: function(username) {
    ...
    var promise = new Promise(function(resolve, reject) {
      ...
      cartsReq.onload = function() {
        self.results = JSON.parse(cartsReq.responseText);
        resolve();
      };
      cartsReq.onerror = function() {
        reject(Error("It broke"));
      };
      cartsReq.open('GET', '/usercart/' + username + '/findallcarts');
      cartsReq.send(null);
  ...
  // DELETE:Replaced by loadUserCartData using Promise
  ...
  addResult: function(result, renderCallback) {
    ...
    var loadUserCartPromise = addCartPromise.then(self.loadUserCartData);
